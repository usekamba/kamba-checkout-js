        ...
        fetch(url, {method: 'POST',
          ...
          body:  JSON.stringify({
            ...
            if (response.ok) {
                  ...
                  <section>
                      ...
                      <article class="qrPartKambaMerchant">
                        ...
                        <div class="openAppKamba">
                          <a href="https://comerciante.usekamba.com/pay?chID=${checkoutId}" class="btnKamba">
              ...
              let mechantCheckoutLink = 'https://comerciante.usekamba.com/pay?chID='+checkoutId;
    
              new QRCode(document.getElementById('qrCodeKamba'), mechantCheckoutLink);
