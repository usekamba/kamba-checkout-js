      ...
      ready(function(){
        ...
        fetch(url, {method: 'POST',
          ...
          if(response.ok) {
            ...
            if (isMobileDevice()) {
              var userId = data.merchant.id
              var checId = data.id

              if ( getMobileOperatingSystem() == "Android" ) {
                location.href="https://checkout.usekamba.com/v1/pay?mID="+userId+"&chID="+checId+"";

                //location.href='https://play.google.com/store/apps/details?id=com.usekamba.kamba.kamba';
              } else if ( getMobileOperatingSystem() == "iOS" ) {
                location.href='https://itunes.apple.com/app/kamba-pagamentos-m%C3%B3veis/id1268906716';
              }
            }
            ...
            let newDateConvert = [dateConvert.getDate(), dateConvert.getMonth(), dateConvert.getFullYear()].join('/')+' Ã s '+[dateConvert.getHours(), dateConvert.getMinutes(), dateConvert.getSeconds()].join(':');
                          ...
                          <div  class="descriptionKamba">
                              ...
                              <div class="helpKamba">
                                  ...
                                  <div class="optionHelpKamba1">
                                      Abra o aplicativo Kamba no seu telemÃ³vel e digitalize o cÃ³digo de pagamento.
                                  </div>

                                  <div class="optionHelpKamba2">NÃ£o tem uma conta Kamba? <a href="https://usekamba.com/"  target="_blank" class="appLinkKamba"> FaÃ§a download do aplicativo.</a>
                                  </div>
        ...
        .catch(function(error) {
            ...
            let textErrorKamba = document.querySelector(".textErrorKamba");
            textErrorKamba.innerHTML = "Verifique sua conexÃ£o com a internet, ela pode estar muito lenta";
        });
